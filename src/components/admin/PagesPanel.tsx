...
const SECTIONS: Section[] = [
  {
    ...
    fields: [
      ...
      { kind: "text", label: "Military discount badge", path: "pages.home.militaryBadge", hint: "The pill under the hero buttons." },
      { kind: "text", label: "Yellow marquee text", path: "site.tagline", hint: "The scrolling banner under the hero. Also used elsewhere as your tagline (Settings)." },
    ],
  },
  {
    id: "about",
  ...
  },
  {
    ...
    fields: [
      ...
      { kind: "text", label: "“Call or text” label", path: "pages.contact.callLabel" },
      { kind: "text", label: "“Email us” label", path: "pages.contact.emailLabel" },
      { kind: "text", label: "“Delivery” label", path: "pages.contact.deliveryLabel" },
      { kind: "text", label: "“Follow along” label", path: "pages.contact.followLabel" },
    ],
  },
  {
    id: "shop",
  ...
  },
  {
    ...
    fields: [
      ...
      { kind: "text", label: "Comparison eyebrow", path: "pages.bundles.compareEyebrow" },
      { kind: "text", label: "Comparison title", path: "pages.bundles.compareTitle" },
      { kind: "area", label: "Comparison body", path: "pages.bundles.compareBody", rows: 2 },
      { kind: "text", label: "Add-ons eyebrow", path: "pages.bundles.addonsEyebrow" },
      { kind: "text", label: "Add-ons title", path: "pages.bundles.addonsTitle" },
      { kind: "area", label: "Add-ons body", path: "pages.bundles.addonsBody", rows: 2 },
      { kind: "text", label: "FAQ eyebrow", path: "pages.bundles.faqEyebrow" },
      { kind: "text", label: "FAQ title", path: "pages.bundles.faqTitle" },
      {
        kind: "pairs",
        label: "FAQ",
      ...
      { kind: "text", label: "Bottom CTA eyebrow", path: "pages.bundles.ctaEyebrow" },
      { kind: "text", label: "Bottom CTA title", path: "pages.bundles.ctaTitle" },
      { kind: "area", label: "Bottom CTA body", path: "pages.bundles.ctaBody", rows: 2 },
    ],
  },
  {
    id: "availability",
  ...
  },
  {
    id: "reviews",
    label: "Reviews page",
    blurb: "Header + empty-state copy. The rating and review cards are automatic.",
    fields: [
      { kind: "area", label: "Subtitle", path: "pages.reviews.subtitle", rows: 2 },
      { kind: "text", label: "Empty-state title", path: "pages.reviews.emptyTitle", hint: "Shown only when there are no reviews yet." },
      { kind: "area", label: "Empty-state body", path: "pages.reviews.emptyBody", rows: 2 },
      { kind: "text", label: "“Read on Google” button", path: "pages.reviews.googleCta" },
      { kind: "text", label: "Verified note", path: "pages.reviews.verifiedNote" },
    ],
  },
  {
    id: "blog",
    label: "Blog page",
    blurb: "Header + the booking call-to-action. Articles themselves live in code.",
    fields: [
      { kind: "text", label: "Eyebrow", path: "pages.blog.eyebrow" },
      { kind: "text", label: "Title", path: "pages.blog.title" },
      { kind: "area", label: "Subtitle", path: "pages.blog.subtitle", rows: 2 },
      { kind: "text", label: "“Back to all” link", path: "pages.blog.backLink" },
      { kind: "text", label: "Article CTA title", path: "pages.blog.ctaTitle" },
      { kind: "area", label: "Article CTA subtext", path: "pages.blog.ctaSub", rows: 2 },
    ],
  },
  {
    id: "footer",
    label: "Footer",
    blurb: "The site footer shown on every page.",
    fields: [
      { kind: "area", label: "Description", path: "pages.footer.description", rows: 2 },
      { kind: "text", label: "“Licensed & Insured” badge", path: "pages.footer.licensedNote" },
      { kind: "text", label: "“Explore” heading", path: "pages.footer.exploreHeading" },
      { kind: "text", label: "“Company” heading", path: "pages.footer.companyHeading" },
      { kind: "text", label: "“Service areas” heading", path: "pages.footer.serviceAreasHeading" },
      { kind: "text", label: "Service-area question", path: "pages.footer.areaQuestion" },
      { kind: "text", label: "Service-area button", path: "pages.footer.areaCta" },
      { kind: "text", label: "Service-area note", path: "pages.footer.areaNote" },
      { kind: "text", label: "“Partner with” note", path: "pages.footer.partnerNote" },
      { kind: "text", label: "Closing tagline", path: "pages.footer.closingTagline" },
    ],
  },
];
